...
class PaintingActivity: BaseActivity(), ActionDoneInterface {
    ...
    private fun handleGetImageAssets(){
        handleGetImage()
        try {
            val urlMove1 = assets.open("animal/" + listImageMoveSelect[0])
            val urlPie1 = assets.open("animal1/"+listImagePieSelect[0])
            val urlMove2 = assets.open("animal/" +listImageMoveSelect[1])
            val urlPie2 = assets.open("animal1/" +listImagePieSelect[1])
            val urlMove3 = assets.open("animal/" +listImageMoveSelect[2])
            val urlPie3 = assets.open("animal1/" +listImagePieSelect[2])
            val urlMove4 = assets.open("animal/" +listImageMoveSelect[3])
            val urlPie4 = assets.open("animal1/" +listImagePieSelect[3])
    ...
    private fun handleSetupImageMove(){
        ...
        var x1 = location[0]
        var y1 = location[1]
        val puzzlePiece1 = AnimalPiece(this)

        puzzlePiece1.canMove = true
        puzzlePiece1.xCoord = x1
        puzzlePiece1.yCoord = y1 - 50
        ...
        val puzzlePiece4 = AnimalPiece(this)
        imagePie4.getLocationOnScreen(location)
        var x4 = location[0]
        var y4 = location[1]
        puzzlePiece4.canMove = true
        puzzlePiece4.xCoord = x4
        puzzlePiece4.yCoord = y4 - 50
    ...
    private fun handleShowView(id: Int){
        val showAnimation = AnimationUtils.loadAnimation(this, R.anim.show_view)
        when(id){
            R.id.imageMove1 -> {
                musicDone()
    ...
    override fun actionDone(id: Int) {
        handleShowView(id)
    }
}