package com.to.game.puzzle.kids.object;

import android.opengl.GLES20;

import com.to.game.puzzle.kids.data.VertexArray;
import com.to.game.puzzle.kids.program.TextureShaderProgram;
...
public class BackgroundTable {
    ...
    static {
        VERTEX_DATA = new float[]{0.0f, 0.0f, 8.0f, 8.0f, -1.0f, -1.0f, 0.0f, 16.0f, 1.0f, -1.0f, 16.0f, 16.0f, 1.0f, 1.0f, 16.0f, 0.0f, -1.0f, 1.0f, 0.0f, 0.0f, -1.0f, -1.0f, 0.0f, 16.0f};
    }
